...
namespace Randomly.content.tiles.relics
{
	...
	public class Relic_FrostFlower : ModTile
	{
		...
		public virtual string RelicTextureName => "Randomly/content/tiles/relics/Relic_FrostFlower";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "Randomly/content/tiles/relics/Relic_Pedestal";
