...
namespace Randomly.common.systems
{
	...
	public class System_DownedBossSystem : ModSystem
	{
		public static bool DownedBoss_FrostFlower = false;
		public static bool DownedBoss_SpacePiece = false;
		
		// public static bool downedOtherBoss = false;

		public override void ClearWorld() {
			DownedBoss_FrostFlower = false;
			DownedBoss_SpacePiece = false;
		...
		public override void SaveWorldData(TagCompound tag) {
			if (DownedBoss_FrostFlower) {
				tag["DownedBoss_FrostFlower"] = true;
			}
			if (DownedBoss_SpacePiece) {
				tag["DownedBoss_SpacePiece"] = true;
			}
		...
		public override void LoadWorldData(TagCompound tag) {
			DownedBoss_FrostFlower = tag.ContainsKey("DownedBoss_FrostFlower");
			DownedBoss_SpacePiece = tag.ContainsKey("DownedBoss_SpacePiece");
		...
		public override void NetSend(BinaryWriter writer) {
			...
			flags[0] = DownedBoss_FrostFlower;
			flags[1] = DownedBoss_SpacePiece;
		...
		public override void NetReceive(BinaryReader reader) {
			...
			DownedBoss_FrostFlower = flags[0];
			DownedBoss_SpacePiece = flags[1];
